...
read -p "Ingresa el nombre del host (por ejemplo, vm2.192.168.0.102.nip.io): " nombre_host
...
read -p "Ingresa la dirección IP y la máscara de red (por ejemplo, 192.168.0.102/24): " direccion_ip_mascara_red
...
read -p "Ingresa la cadena de búsqueda (por ejemplo, 192.168.0.102.nip.io): " cadena_busqueda
