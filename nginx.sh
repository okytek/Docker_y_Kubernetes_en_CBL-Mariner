...
# Reemplaza las cadenas en nginx.yaml
sed -i "s/BASE64_ENCODED_TLS_CERTIFICATE/${ENCODED_CERT}/" nginx.yaml
sed -i "s/BASE64_ENCODED_TLS_PRIVATE_KEY/${ENCODED_KEY}/" nginx.yaml
